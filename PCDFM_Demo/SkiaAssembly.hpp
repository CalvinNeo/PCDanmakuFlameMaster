#ifndef _PCDFM_DEMO_SKIA_ASSEMBLY_HPP
#define _PCDFM_DEMO_SKIA_ASSEMBLY_HPP
...
#define SK_DEVELOPER 1
    ...
    #pragma comment (lib, "3rdparty/skia_lib_debug/libEGL.dll.lib")
#else

#endif

#endif // _PCDFM_DEMO_SKIA_ASSEMBLY_HPP
